...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const noSidebarPrefixes = ['/topics/', '/admin/', '/kol/', '/entertainment/', '/facial-care/', '/anti-aging/', '/body-care/', '/skincare/', '/healthy-diet/', '/salon/', '/merchant-registration', '/merchant-signup', '/merchant-consulting', '/merchant-contact', '/merchant-cooperation', '/merchant-marketing'];
