        ...
        >
          {images.map((img, i) => (
            ...
            >
              ...
              />
              {i === selectedIndex && (
                <div className="absolute bottom-0.5 left-1/2 -translate-x-1/2 w-4 h-0.5 bg-purple-400 rounded-full" />
              )}
            </button>
          ))}
        </div>
...
export default function AntiAgingArticlePage() {
  ...
  if (loading) {
    return (
      <PublicLayout activeHref="/anti-aging">
