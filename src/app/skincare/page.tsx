      ...
      try {
        ...
        if (data) {
          ...
          const sortedTags = Object.entries(tagCounts)
            ...
            .map(([tag]) => tag)
            .slice(0, 16);
          setPopularTags(sortedTags.length > 0 ? sortedTags : ['底妝', '遮瑕', '防曬', '精華液', '面膜', '韓妝', '眼影', '唇膏', '卸妝', '保濕', '美白', '抗衰老']);
        }
      } catch (err) {
            ...
            <section>
              ...
              {loading ? (
                ...
                <div className="text-center py-16 bg-white/60 rounded-xl border border-slate-100/60">
                  ...
                  <p className="text-sm text-slate-400">敬請期待更多化妝護膚相關文章！</p>
                </div>
              )}
            </section>
